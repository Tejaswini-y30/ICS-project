...
# GUI STUFF
top=tk.Tk()
top.config(background = "LightSalmon2")
...
msgtitle.config(font=('helvetica',17,'bold'),width=300,background = "LightSalmon2")
msgtitle.pack()

sp="---------------------------------------------------------------------"
sp_title=Message(top,text=sp)
sp_title.config(font=('arial',12),width=650,background = "LightSalmon2")
sp_title.pack()
