...
from AESencrypt import AESencrypt_main
...
def Next_Step():
    ...
    myhexstring=AESencrypt_main(file_text,key)
    print("The output hex value for the entire message is:\n%s\n" % myhexstring)
    #Tk.messagebox.showinfo("Encryption Alert","Encryption ended successfully. File")
...
button_next = Tk.Button(win,text = "Encrypt",height =2,width=10,command = Next_Step)
...
win.config(background = "seashell2")
